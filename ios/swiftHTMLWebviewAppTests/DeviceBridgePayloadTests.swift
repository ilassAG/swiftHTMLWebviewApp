...
final class DeviceBridgePayloadTests: XCTestCase {
    func testCapabilitiesReflectInjectedRuntimeSupport() {
        ...
        XCTAssertEqual(capabilities["natsProvision"] as? Bool, true)
        XCTAssertEqual(capabilities["natsStatus"] as? Bool, true)
        XCTAssertEqual(capabilities["natsConnect"] as? Bool, true)
        XCTAssertEqual(capabilities["natsDisconnect"] as? Bool, true)
        XCTAssertEqual(capabilities["natsPublish"] as? Bool, true)
